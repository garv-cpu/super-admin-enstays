...
export function SuperAdminLayout() {
  return (
    <div className="console-shell h-screen overflow-hidden text-enstays-text lg:grid lg:grid-cols-[248px_1fr] lg:grid-rows-[64px_1fr]">
      ...
      <aside className="hidden min-h-0 overflow-y-auto border-r border-enstays-line bg-enstays-bg2 lg:block">
        ...
        <div className="sticky bottom-0 border-t border-enstays-line bg-enstays-bg2 p-4">
