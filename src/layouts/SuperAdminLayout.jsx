...
export function SuperAdminLayout() {
  ...
  const displayName = user?.first_name || user?.name || user?.email || 'Platform Owner';
  ...
  return (
    <div className="console-shell h-screen overflow-hidden text-enstays-text lg:grid lg:grid-cols-[248px_1fr] lg:grid-rows-[64px_1fr]">
      <header className="z-30 col-span-full flex h-16 shrink-0 items-center gap-4 border-b border-enstays-line bg-enstays-bg2 px-5 shadow-console">
        ...
        <div className="hidden items-center gap-2 rounded-full border border-enstays-line bg-enstays-surface py-1 pl-1 pr-2 sm:flex">
          ...
          <div className="hidden leading-tight sm:block">
            <p className="max-w-[140px] truncate text-[12.5px] font-semibold text-enstays-text">
              {displayName}
            </p>
          ...
          <button
            onClick={logout}
            className="ml-1 rounded-full p-2 text-enstays-text3 transition hover:bg-enstays-bg2 hover:text-enstays-gold"
            title="Logout"
            type="button"
          >
            <LogOut size={15} />
      ...
      <aside className="hidden min-h-0 flex-col overflow-hidden border-r border-enstays-line bg-enstays-bg2 lg:flex">
        <div className="m-4 rounded-[13px] border border-enstays-goldLine bg-enstays-goldSoft p-[13px]">
          ...
          <p className="mt-1 truncate text-[14.5px] font-semibold text-enstays-text">
            Super Admin
          </p>
